...
<div class="container">
    ...
    <a href="<%= request.getContextPath() %>/admin/admin-dashboard.jsp" style="text-decoration: none; color: #3498db;">← Back to Dashboard</a>
    <hr>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="../FarmServlet?action=edit&farmId=<%= farm.getFarmId() %>" class="btn-edit">Edit</a>
                    <a href="../FarmServlet?action=delete&farmId=<%= farm.getFarmId() %>" class="btn-delete" onclick="return confirmDelete()">Delete</a>
                </td>
            </tr>
            <%
                    }
